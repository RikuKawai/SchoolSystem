...
import moe.thisis.SchoolSystem.StudentInput;
...
public class StudentSystem {
	...
	private ArrayList<Student> studRecs;
	
	public ArrayList<Student> getStudRecs() {
		return studRecs;
	}
	 ...
	 * @throws IOException
	 */
	public void getStudentInput(Student student) throws IOException {
		/**
